...
### 오토플러스
- 2020.01 ~ : **IT개발실 / 과장 (UI개발 담당)**
> - 옵션 선택형 중고차 UI (PC) (UI개발, 100%참여)
> - <a href="https://simbyungki.github.io/ui_modules/car_state.html">중고차 상태(사고부위)관리 UI (PC)</a> (UI개발, 100%참여)
> - 오토플러스 1.0 통합사이트 (PC/Mobile) (UI개발, 100%참여)
